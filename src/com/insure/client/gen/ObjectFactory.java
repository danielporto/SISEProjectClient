...
public class ObjectFactory {
    ...
    private final static QName _AddEmployee_QNAME = new QName("http://server.insure.com/", "addEmployee");
    private final static QName _AddEmployeeResponse_QNAME = new QName("http://server.insure.com/", "addEmployeeResponse");
    private final static QName _DeleteEmployee_QNAME = new QName("http://server.insure.com/", "deleteEmployee");
    private final static QName _DeleteEmployeeResponse_QNAME = new QName("http://server.insure.com/", "deleteEmployeeResponse");
    private final static QName _GetEmployee_QNAME = new QName("http://server.insure.com/", "getEmployee");
    private final static QName _GetEmployeeResponse_QNAME = new QName("http://server.insure.com/", "getEmployeeResponse");
    private final static QName _UpdateEmployee_QNAME = new QName("http://server.insure.com/", "updateEmployee");
    private final static QName _UpdateEmployeeResponse_QNAME = new QName("http://server.insure.com/", "updateEmployeeResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://server.insure.com/", name = "addEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://server.insure.com/", name = "addEmployeeResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://server.insure.com/", name = "deleteEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://server.insure.com/", name = "deleteEmployeeResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://server.insure.com/", name = "getEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://server.insure.com/", name = "getEmployeeResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://server.insure.com/", name = "updateEmployee")
     ...
     */
    @XmlElementDecl(namespace = "http://server.insure.com/", name = "updateEmployeeResponse")
